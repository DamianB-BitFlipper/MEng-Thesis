...
%% 
%% \iffalse
%% Under heavy concurrent load, the latency penalty of the additional HTTP request is as high as 70 milliseconds.

%% Under heavy load, the latency penalty of the additional HTTP request is up to 1.5x slower than accessing the original web service directly without WebAuthn.
%% \fi
%% 
